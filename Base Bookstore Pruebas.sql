...
/*						ALEX CARRERA							*/
/*					SERGIO VILLACRÉS							*/
/*		Creacion de la Base de Datos BDD_BOOKSTORE_PRUEBAS		*/
/*==============================================================*/

USE master
GO

CREATE DATABASE BDD_BOOKSTORE_PRUEBAS
ON PRIMARY
(NAME='PRIMARY_DAT',
 FILENAME=
 'E:\FileGroupsSQL2\PRIMARY_DAT.mdf',
 SIZE=10MB,
 MAXSIZE=65MB,
 FILEGROWTH=1MB),
FILEGROUP BDD_BOOKSTORE_PRUEBAS_CATALOGO
 (NAME='BDD_BOOKSTORE_PRUEBAS_CATALOGO',
 FILENAME=
 'E:\FileGroupsSQL2\BDD_BOOKSTORE_PRUEBAS_CATALOGO.ndf',
 SIZE=10MB,
 MAXSIZE=65MB,
 FILEGROWTH=1MB),
FILEGROUP BDD_BOOKSTORE_PRUEBAS_VENTAS
 ( NAME = 'BDD_BOOKSTORE_PRUEBAS_DATOS_1',
 FILENAME =
 'E:\FileGroupsSQL2\BDD_BOOKSTORE_PRUEBAS_DAT_1.ndf',
 SIZE = 5MB,
 MAXSIZE=50MB,
 FILEGROWTH=1MB),
 ( NAME = 'BDD_BOOKSTORE_PRUEBAS_DATOS_2',
 FILENAME =
 'E:\FileGroupsSQL2\BDD_BOOKSTORE_PRUEBAS_DAT_2.ndf',
 SIZE = 5MB,
 MAXSIZE=50MB,
 FILEGROWTH=1MB)
LOG ON
 ( NAME='BDD_BOOKSTORE_PRUEBAS_LOG_1',
 FILENAME =
 'E:\FileGroupsSQL2\BDD_BOOKSTORE_PRUEBAS_LOG_1.ldf',
 SIZE=5MB,
 MAXSIZE=35MB,
 FILEGROWTH=1MB),
 ( NAME='BDD_BOOKSTORE_PRUEBAS_LOG_2',
 FILENAME =
 'E:\FileGroupsSQL2\BDD_BOOKSTORE_PRUEBAS_LOG_2.ldf',
 SIZE=5MB,
 MAXSIZE=35MB, 
 FILEGROWTH=1MB);
GO
...
ON BDD_BOOKSTORE_PRUEBAS_CATALOGO;
GO
...
ON BDD_BOOKSTORE_PRUEBAS_VENTAS;
go
